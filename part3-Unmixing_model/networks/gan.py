...
class generator(nn.Module):
    ...
    def __init__(self, opts):
        ...
        self.gated_deconv1 = gated_deconv(opts, pad_type, in_ch=1024, out_ch=1024, size=4)
        self.gated_deconv2 = gated_deconv(opts, pad_type, in_ch=1024, out_ch=512, size=8)
        self.gated_deconv3 = gated_deconv(opts, pad_type, in_ch=512, out_ch=256, size=16)
        self.gated_deconv4 = gated_deconv(opts, pad_type, in_ch=256, out_ch=128, size=32)
        self.gated_deconv5 = gated_deconv(opts, pad_type, in_ch=128, out_ch=64, size=64)
...
class Encoder(nn.Module):
    def __init__(self,opts,comb,d=64):
        super(Encoder,self).__init__()
        input_ch = 2 # for HPA : input_ch=2; for real dataset input_ch=1
        self.conv1 = nn.Conv2d(2,d,4,2,1,bias=False)
...
class gated_deconv(nn.Module):
    def __init__(self,opts,pad_type,in_ch, out_ch, size):
